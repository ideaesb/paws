...
<div id = "container" > <!--container that holds main text and map -->
  ...
  <div id="hover1"><a href="dataproducts3.jsp?regions=1">Data and Products</a><br><a href="projects3.jsp?regions=1">Projects and Activities</a></div>
  <div id="hover2"><a href="dataproducts3.jsp?regions=2">Data and Products</a><br><a href="projects3.jsp?regions=2">Projects and Activities</a></div>
  <div id="hover3"><a href="dataproducts3.jsp?regions=3">Data and Products</a><br><a href="projects3.jsp?regions=3">Projects and Activities</a></div>	 		
