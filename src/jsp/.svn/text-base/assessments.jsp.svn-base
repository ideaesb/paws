...
<ul id="nav">
  ...
  <li id="nav-1"><a href="assessments.jsp" title="asses"><span>A S S E S S M E N T S</span></a></li>
...
%>
   ...
   <table class="project-box">
    ...
    <tr>
     ...
     <td><a href='<%= application.getInitParameter("baseurl") %><%= assessment.getWorksheet() %>'><%= assessment.getName() %></a></td>
    </tr>
    <tr>
     <td>Description</td>
     <td><%= assessment.getDescription() %></td>
    </tr>
    <tr>
     <td>Status</td>
    ...
    <table id="browse-box">
     <tr>
      ...
      By Assessment Type:<br />
       <select id="assessments" name="assessments" multiple="multiple" size="4" width="350" style="width: 350px;font-size:11px;overflow: auto;">
     ...
     <tr>
      ...
      By Area of Applicability:<br />
       <select id="applicabilities" name="applicabilities" multiple="multiple" size="4" width="350" style="width: 350px;font-size:11px;overflow: auto;">
     ...
     <tr>
      <td>
      By Focus Area:<br />
       <select id="focii" name="focii" multiple="multiple" size="4" width="350" style="width: 350px;font-size:11px;overflow: auto;">
